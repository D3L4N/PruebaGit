    ...
    <header>
        <div class="container__menu">
            <div class="menu">
                ...
                <nav class="nav">
                    <ul>
                        <li><a href="Panel_Administrador.php" id="selected"></a></li>
                        <li><a href="#">Usuarios</a>
                            <ul>
                                <li><a href="Registro_Usuarios.php">Registrar</a></li>
                                <li><a href="Crud_Usuarios.php">Administrar</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="#">Informes</a>
                            <ul>
                                <li><a href="Generar_informes.php">Generar Informes</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
